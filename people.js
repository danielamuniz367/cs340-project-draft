module.exports = function(){
    ...
    function getPeople(res, mysql, context, complete){
        mysql.pool.query("SELECT students.id as id, fname, lname, houses.name AS house_id, class_year FROM students INNER JOIN houses ON house_id = students.house_id", function(error, results, fields){
            if(error){
                res.write(JSON.stringify(error));
                res.end();
            }
